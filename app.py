...
# --- 1. SECURE HARDWARE SYNC ---
# Use your newest key from the fresh project
# Key: AIzaSyBpiMFLtK7z6igFL_xeK0coQGQiL6eg00E
try:
    genai.configure(api_key="AIzaSyBpiMFLtK7z6igFL_xeK0coQGQiL6eg00E")
    # Calling the stable model directly to bypass v1beta routing issues
    model = genai.GenerativeModel('gemini-1.5-flash')
except Exception:
    st.error("🔑 Console Hardware Error: Project Restriction Detected.")
    st.stop()
...
3. Be professional and treat this as a high-level physics lab.
"""
...
if prompt := st.chat_input("Partner, explain the derivation for..."):
    ...
    with st.chat_message("assistant"):
        try:
            ...
            st.error("Brain Sync Failure: Google Cloud has restricted this project. Create a NEW project in AI Studio.")
